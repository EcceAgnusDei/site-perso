...
const about = [(
	<React.Fragment>
		<h3>Qui suis-je?</h3>
		<p>Ingénieur en énergétique de formation
		, je n'ai pas hésité à changer de voie pour me rapprocher 
		d'une matière qui m'a tant plue lors de ma longue carrière universitaire
		: <strong>le code</strong>.</p>
	</React.Fragment>
	),
	(
	<React.Fragment>
